...
category("/g-energy", "g-energy.html", "Моторные масла G-Energy",
         ...
         "Моторные масла G-Energy со склада в Ташкенте: Synthetic Super Start, Far East, Active, Long Life и Expert L. Фасовки от 1 л до бочки, документы на партию.",
  ...
  <section class="section section--tight" id="where">
    <div class="wrap">
      ...
      <div class="findus">
        ...
        <div class="map">
        <picture>
          <source type="image/avif" srcset="/img/map-sm.avif?v=3 600w, /img/map.avif?v=3 1200w" sizes="(max-width:900px) 100vw, 50vw">
          <source type="image/webp" srcset="/img/map-sm.webp?v=3 600w, /img/map.webp?v=3 1200w" sizes="(max-width:900px) 100vw, 50vw">
          <img src="/img/map.webp?v=3" alt="Офис Smart Energy Eco Trade в Ташкенте на карте" width="1200" height="600" loading="lazy" decoding="async">
        </picture>
        <div class="map__go">
