...
<main>
  ...
  <section class="hero">
    <div class="wrap hero__grid">
      ...
      <img class="hero__media" src="/img/hero.webp" srcset="/img/hero-sm.webp 700w, /img/hero-md.webp 960w, /img/hero.webp 1400w" sizes="(max-width:900px) 100vw, 45vw" alt="Gazpromneft moylarini quyish liniyasi" width="{herow}" height="{heroh}" fetchpriority="high" decoding="async">
    </div>
  </section>
